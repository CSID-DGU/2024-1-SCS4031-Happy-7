...
📹[**_서비스 시연영상_**](https://www.youtube.com/watch?v=xJEwnH6WyE4)

👉[**_서비스 바로가기_**](https://observator.co.kr/login)👈

## ⚠ 중요 공지 ⚠

현재 요청으로 인해 서비스가 일시중단되었으며, 서비스의 재개가 필요하다면 연락주세요!

🖥[**_로컬에서 실행하는 방법_**](/Doc/how_to_run.md)

📧[**_서비스 재개 요청하기_**](mailto:sholeept@naver.com)
...
- **회원가입 및 로그인**: 사용자들은 웹 클라이언트를 통해 계정을 생성하고 로그인할 수 있습니다.
...
본 소프트웨어는 독점적이며 기밀입니다. 자세한 내용은 [LICENSE](LICENSE) 파일을 참조하십시오.
